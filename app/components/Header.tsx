      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            {/* Language Toggle */}
            <div className="flex items-center space-x-2 border border-campaign-primary rounded-md">
              <button
                onClick={() => switchLanguage('en')}
                className={`px-3 py-1 text-sm font-medium transition-colors ${
                  locale === 'en'
                    ? 'bg-campaign-primary text-white'
                    : 'text-campaign-primary hover:bg-campaign-light'
                }`}
            ...
            <div className="hidden lg:flex items-center space-x-3">
              <a
                ...
                className="text-campaign-text-light hover:text-campaign-primary transition-colors"
                aria-label="Facebook"
              >
