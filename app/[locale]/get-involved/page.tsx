    ...
    <div className="bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              {t('title')} <span className="text-5xl" aria-hidden="true">✨</span>
            </h1>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="card-hover-lift bg-white rounded-lg shadow-xl p-8 md:p-12 border-t-4 border-campaign-accent">
            ...
            <p className="text-lg text-campaign-text-light mb-8 text-center">
              {t('formDescription')}
            </p>
      ...
      <section className="py-16 bg-campaign-light">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-campaign-primary mb-6">
            {t('socialTitle')}
          </h2>
          <p className="text-lg text-campaign-text-light mb-8">
            {t('socialDescription')}
          </p>
